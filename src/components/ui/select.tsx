...
>(({ className, children, ...props }, ref) => (
    ...
    >
        <>{children}</>
        <ChevronDown size={16} aria-hidden={true} className="opacity-50" colorClassName="accent-foreground" />
    </SelectPrimitive.Trigger>
))
...
const SelectScrollUpButton = ({
    ...
    return (
        <SelectPrimitive.ScrollUpButton
            ...
            {...props}
        >
            <ChevronUp size={14} colorClassName="accent-foreground" />
        </SelectPrimitive.ScrollUpButton>
    )
}
...
const SelectScrollDownButton = ({
    ...
    return (
        <SelectPrimitive.ScrollDownButton
            ...
            {...props}
        >
            <ChevronDown size={14} colorClassName="accent-foreground" />
        </SelectPrimitive.ScrollDownButton>
    )
}
    ...
    >
        <View className="absolute left-2 native:left-3.5 flex h-3.5 native:pt-px w-3.5 items-center justify-center">
            <SelectPrimitive.ItemIndicator>
                <Check size={16} strokeWidth={3} colorClassName="accent-popover-foreground" />
            </SelectPrimitive.ItemIndicator>
        </View>
